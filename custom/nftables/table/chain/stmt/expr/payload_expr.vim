...
hi link    nft_nexthdr_set_block_delimiters nftHL_BlockDelimitersSet
syn region nft_nexthdr_set_block_delimiters start=+{+ end=+}+ skipwhite contained
...
\    nft_nexthdr_set_block_delimiters,
