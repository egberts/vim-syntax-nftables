...
hi link   nft_meta_expr_close_scope_meta_rtclassid_integer_id nftHL_Define
syn match nft_meta_expr_close_scope_meta_rtclassid_integer_id '\v[0-9]{1,10}\ze[ \t;]' skipwhite contained
...
hi link   nft_meta_expr_close_scope_meta_rtclassid_enum_any nftHL_Operator
syn match nft_meta_expr_close_scope_meta_rtclassid_enum_any '\vany\ze[ \t;]' skipwhite contained
...
hi link   nft_meta_expr_priority_set_block_element_separator nftHL_Separator
syn match nft_meta_expr_priority_set_block_element_separator /,/ skipwhite contained
\ nextgroup=
\    nft_meta_expr_priority_set_block_element_protocol_types,
\    nft_meta_expr_priority_set_block_element_protocol_number,
\    nft_Error

hi link   nft_meta_expr_priority_set_block_element_protocol_number nftHL_Integer
syn match nft_meta_expr_priority_set_block_element_protocol_number '\v[0-9]{1,5}' skipwhite contained
syn match nft_meta_expr_priority_set_block_element_protocol_number '\v\c0x[0-9a-f]{1,4}' skipwhite contained
\ nextgroup= nft_meta_expr_priority_set_block_element_separator, nft_Error

hi link   nft_meta_expr_priority_set_block_element_protocol_types nftHL_Identifier
syn match nft_meta_expr_priority_set_block_element_protocol_types '\v(loopback|mpls_mc|mpls_uc|(802_1q)|pppoe|lldp|qinq|arp|ip6|ip)' skipwhite contained
...
\ contains=
\     nft_meta_expr_priority_set_block_element_protocol_identifier,
\     nft_meta_expr_priority_set_block_element_protocol_types,
\     nft_meta_expr_priority_set_block_element_protocol_number,
\     nft_Error
...
syn match nft_protocol_type_set_block_element_protocol_types '\v(udplite|gretap|icmpv6|comp|dccp|icmp|igmp|sctp|esp|gre|tcp|udp|ah)' skipwhite contained
\ nextgroup=
\    nft_protocol_type_set_block_element_separator
...
syn match nft_protocol_type_number '\v(0[xX][0-7]?[0-9a-fA-F]{1,3}|3276[0-7]|327[0-5][0-9]|32[0-6][0-9][0-9]|3[0-1][0-9][0-9][0-9]|[0-2]?[0-9][0-9]?[0-9]?[0-9]?)\ze[ \t;]' skipwhite contained
...
hi link   nft_meta_expr_meta_key_unqualified_keyword_nftrace_value nftHL_Number
syn match nft_meta_expr_meta_key_unqualified_keyword_nftrace_value '\v[0-1]{1}\ze[ \t;]' skipwhite contained
...
syn match nft_meta_expr_close_scope_meta_nfproto_id '\v[0-9]{1,5}\ze[ \t\n;]' skipwhite contained
\ nextgroup=
...
hi link   nft_meta_expr_internal_string_keyword_nfproto nftHL_Substatement
syn match nft_meta_expr_internal_string_keyword_nfproto '\vnfproto\ze[ \t\n;]' skipwhite contained
\ nextgroup=
\    nft_verdict_stmt_verdict_map_stmt_keyword_vmap,
...
syn match nft_packet_length_integer '\v(0[xX][0-9a-fA-F]{8}|0[xX][0-9a-fA-F]{1,7}|[0-3]?[0-9]{1,9}|4[0-1][0-9]{8}|42[0-8][0-9]{7}|429[0-3][0-9]{6}|4294[0-8][0-9]{5}|42949[0-5][0-9]{4}|429496[0-6][0-9]{3}|4294967[0-1][0-9]{2}|42949672[0-8][0-9]|429496729[0-5])\ze[ \t\n;]' skipwhite contained
...
syn match nft_packet_length_set_block_member_integer '\v(0[xX][0-9a-fA-F]{8}|0[xX][0-9a-fA-F]{1,7}|[0-3]?[0-9]{1,9}|4[0-1][0-9]{8}|42[0-8][0-9]{7}|429[0-3][0-9]{6}|4294[0-8][0-9]{5}|42949[0-5][0-9]{4}|429496[0-6][0-9]{3}|4294967[0-1][0-9]{2}|42949672[0-8][0-9]|429496729[0-5])' skipwhite contained
\ nextgroup=
...
hi link   nft_meta_expr_meta_key_qualified_keyword_random_match nftHL_Integer
syn match nft_meta_expr_meta_key_qualified_keyword_random_match '\v[0-9]{1,10}\ze[ \t;]' skipwhite contained
...
\ nextgroup=
\    nft_meta_expr_meta_key_qualified_keyword_random_match

hi link   nft_meta_expr_meta_key_qualified_keyword_random_mod_divisor nftHL_Integer
syn match nft_meta_expr_meta_key_qualified_keyword_random_mod_divisor '\v[0-9]{1,10}\ze[ \t]' skipwhite contained
\ nextgroup=
...
hi link   nft_meta_expr_meta_key_unqualified_keyword_ipsec_special_keywords Define
...
hi link   nft_meta_expr_meta_key_meta_key_qualified_keyword_ipsec_set_keyword_not nftHL_Operator
syn match nft_meta_expr_meta_key_meta_key_qualified_keyword_ipsec_set_keyword_not '\vnot\ze[ \t\{]' skipwhite contained
\ nextgroup=
...
hi link   nft_meta_expr_meta_key_unqualified_ipsec_keyword_not nftHL_Expression
syn match nft_meta_expr_meta_key_unqualified_ipsec_keyword_not '\vnot' skipwhite contained
...
\ nextgroup=
\    nft_meta_expr_meta_key_meta_key_qualified_keyword_ipsec_special_keywords,
\    nft_meta_expr_meta_key_meta_key_qualified_keyword_ipsec_set_keyword_not,
\    nft_meta_expr_meta_key_meta_key_qualified_keyword_ipsec_set_keyword_spi,
\    nft_meta_expr_meta_key_meta_key_qualified_keyword_ipsec_set_keyword_out,
\    nft_meta_expr_meta_key_meta_key_qualified_keyword_ipsec_set_keyword_in,
\    nft_meta_expr_meta_key_unqualified_ipsec_keyword_missing,
\    nft_meta_expr_meta_key_unqualified_ipsec_keyword_exists,
\    nft_meta_expr_meta_key_unqualified_ipsec_keyword_not,
...
syn match nft_meta_expr_meta_key_unqualified_mark_integer '\v\@[a-zA-Z][a-zA-Z0-9]{0,63}' skipwhite contained
...
\    nft_Error
hi link   nft_meta_expr_meta_key_unqualified_mark_set_block_element_integer nftHL_Integer
syn match nft_meta_expr_meta_key_unqualified_mark_set_block_element_integer '\v[0-9]{1,10}' skipwhite contained
syn match nft_meta_expr_meta_key_unqualified_mark_set_block_element_integer '\v0x[0-9a-f]{1,8}' skipwhite contained
\ nextgroup=
\    nft_meta_expr_meta_key_unqualified_mark_set_block_element_separator,
\    nft_Error

hi link   nft_meta_expr_meta_key_unqualified_mark_set_block_element_separator nftHL_Separator
syn match nft_meta_expr_meta_key_unqualified_mark_set_block_element_separator /,/ skipwhite contained
\ nextgroup=
\    nft_meta_expr_meta_key_unqualified_mark_set_block_element_integer
...
hi link   nft_meta_expr_meta_key_unqualified_mark_keyword_not nftHL_Operator
syn match nft_meta_expr_meta_key_unqualified_mark_keyword_not '\vnot\ze[ \t]' skipwhite contained
\ nextgroup=
\    @nft_c_mark,
\    nft_Error
...
\ nextgroup=
\    nft_map_expr_keyword_map,
\    nft_meta_expr_meta_key_unqualified_mark_keyword_not,
\    @nft_c_mark,
\    nft_Error
...
hi link   nft_cpu_index_named_set_identifier nftHL_AtSetname
