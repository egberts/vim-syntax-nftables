...
"
let s:get_cmd_list_filepaths_semantic_early = []
let s:get_cmd_list_filepaths_semantic_later = []

if exists('b:did_nftables_get_cmd')
  call nftables#syntax#log('INFO', 'Skipped get_cmd (already loaded for buffer: ' . bufname('%') . ')')
  finish
endif
...
try
  ...
  for s:this_semantic_file in s:get_cmd_list_filepaths_semantic_early
    call nftables#syntax#log('OK', 'Loading ' . s:this_semantic_file)
    call nftables#syntax#load(s:this_semantic_file)
    call nftables#syntax#log('OK', 'Loaded ' . s:this_semantic_file)
  endfor
  call nftables#syntax#debug('Loading get_cmd syntax ...' )
...
"***************** get_cmd END *****************
  ...
  for s:this_semantic_file in s:get_cmd_list_filepaths_semantic_later
    call nftables#syntax#log('OK', 'Loading ' . s:this_semantic_file)
    call nftables#syntax#load(s:this_semantic_file)
    call nftables#syntax#log('OK', 'Loaded ' . s:this_semantic_file)
  endfor
  call nftables#syntax#log('INFO', 'Loaded get_cmd for buffer: ' . bufname('%'))
catch
  call nftables#syntax#log('ERROR', 'Failed to define get_cmd.vim: ' . v:exception . ' at line ' . line('.') . ' in ' . expand('<sfile>:t') . ' at ' . v:throwpoint)
endtry
...
let b:nft_did_nftables_get_cmd = v:true
