...
" ip protocol icmp type <type_name>
hi link   nft_icmp_hdr_expr_close_scope_icmp_type_symbol_expr_variable_expr nftHL_Variable
syn match nft_icmp_hdr_expr_close_scope_icmp_type_symbol_expr_variable_expr '\v\$[a-zA-Z][a-zA-Z0-9\-_]{0,63}\ze[ \t\n;]' skipwhite contained
\ nextgroup=
\    @nft_c_stmt

" BEGIN Operators - Set membership
hi link   nft_icmp_hdr_expr_close_scope_icmp_type_set_ref_expr_set_ref_symbol_expr_at_setname nftHL_Variable
syn match nft_icmp_hdr_expr_close_scope_icmp_type_set_ref_expr_set_ref_symbol_expr_at_setname '\v\@[a-zA-Z][a-zA-Z0-9\-_]{0,63}\ze[ \t]' skipwhite contained
\ nextgroup=
\    @nft_c_stmt

hi link   nft_icmp_hdr_expr_close_scope_icmp_type_set_expr_integer_expr_num_uint8_hex nftHL_Integer
syn match nft_icmp_hdr_expr_close_scope_icmp_type_set_expr_integer_expr_num_uint8_hex '\v(0x([A-Fa-f0-9]{1,2}))|(25[0-5])|(2[0-4][0-9])|(1[0-9][0-9])|([0-9]{1,2})\ze[ \t\n,]' skipwhite contained
\ nextgroup=
\    @nft_c_icmp

hi link   nft_icmp_hdr_expr_close_scope_icmp_type_set_expr_range_stmt_expr_symbol_dash nftHL_elements
syn match nft_icmp_hdr_expr_close_scope_icmp_type_set_expr_range_stmt_expr_symbol_dash '\-' contained
\ nextgroup=
\    nft_icmp_hdr_expr_close_scope_icmp_type_set_expr_integer_expr_num_uint8_hex,
\    nft_Error

hi link   nft_icmp_hdr_expr_close_scope_icmp_type_set_expr_integer_expr_num_uint8_hex_range nftHL_Integer
syn match nft_icmp_hdr_expr_close_scope_icmp_type_set_expr_integer_expr_num_uint8_hex_range '\v(0x([A-Fa-f0-9]{1,2}))|(25[0-5])|(2[0-4][0-9])|(1[0-9][0-9])|([0-9]{1,2})\ze\-' contained
\ nextgroup=
\    nft_icmp_hdr_expr_close_scope_icmp_type_set_expr_range_stmt_expr_symbol_dash

hi link   nft_icmp_hdr_expr_close_scope_icmp_type_set_list_member_expr_symbol_expr_string_keyword_defines nftHL_Define
syn match nft_icmp_hdr_expr_close_scope_icmp_type_set_list_member_expr_symbol_expr_string_keyword_defines
...
hi link    nft_icmp_hdr_expr_type_set_expr_inline_set nftHL_BlockDelimitersSet
syn region nft_icmp_hdr_expr_type_set_expr_inline_set start=+{+ end=+}+ skipwhite contained
\ contains=
...
" BEGIN Operators - Scalar
hi link   nft_icmp_hdr_expr_close_scope_icmp_type_integer_expr_num_uint8_hex nftHL_Integer
syn match nft_icmp_hdr_expr_close_scope_icmp_type_integer_expr_num_uint8_hex '\v(0x([A-Fa-f0-9]{1,2}))|(25[0-5])|(2[0-4][0-9])|(1[0-9][0-9])|([0-9]{1,2})\ze[ \t\n,]' skipwhite contained
\ nextgroup=
\    @nft_c_icmp
...
hi link   nft_icmp_hdr_expr_close_scope_icmp_type_integer_expr_num_uint8_hex_range nftHL_Integer
syn match nft_icmp_hdr_expr_close_scope_icmp_type_integer_expr_num_uint8_hex_range '\v(0x([A-Fa-f0-9]{1,2}))|(25[0-5])|(2[0-4][0-9])|(1[0-9][0-9])|([0-9]{1,2})\ze\-' contained
\ nextgroup=
\    nft_icmp_hdr_expr_close_scope_icmp_type_set_expr_range_stmt_expr_symbol_dash

hi link   nft_icmp_hdr_expr_close_scope_icmp_type_symbol_expr_string_keyword_defines nftHL_Define
syn match nft_icmp_hdr_expr_close_scope_icmp_type_symbol_expr_string_keyword_defines
\    '\v(destination\-unreachable|address\-mask\-request|router\-advertisement|info\-request|router\-solicitation|address\-mask\-reply|info\-reply|parameter\-problem|timestamp\-request|timestamp\-reply|source\-quench|time\-exceeded|echo\-request|echo\-reply|redirect)\ze[ \t\n,\}]'
\ skipwhite contained
\ nextgroup=
\    @nft_c_icmp,
...
\    nft_UnexpectedAtSymbol,
\    nft_Error
"\    nft_icmp_hdr_expr_type_set_expr_inline_set_not_integer,
" discrete operator ONLY with integer, inline set, setname, IP w/o CIDR
" discrete operator cannot do symbol-string (enum), IP w/ CIDR prefix, nor asterisk_string
...
hi link   nft_icmp_hdr_expr_close_scope_icmp_type_relational_expr_relational_op_keyword_not nftHL_Operator
syn match nft_icmp_hdr_expr_close_scope_icmp_type_relational_expr_relational_op_keyword_not '\v(\!\=)\ze[ \t]' skipwhite contained
\ nextgroup=
\    nft_icmp_hdr_expr_close_scope_icmp_type_symbol_expr_string_keyword_defines,
\    nft_icmp_hdr_expr_close_scope_icmp_type_integer_expr_num_uint8_hex_range,
\    nft_icmp_hdr_expr_close_scope_icmp_type_integer_expr_num_uint8_hex,
...
hi link   nft_icmp_hdr_expr_close_scope_icmp_type_symbol_expr_string_keyword_any nftHL_Operator
syn match nft_icmp_hdr_expr_close_scope_icmp_type_symbol_expr_string_keyword_any '\vany\ze[ \t;]' skipwhite contained
\ nextgroup=
\    @nft_c_stmt
"###########################################################3"
...
\ nextgroup=
\    @nft_c_payload_expr_udp_expressions,
" \    nft_payload_expr_close_scope_tcp_sport_dash_symbol TODO
