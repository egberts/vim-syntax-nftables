...
syn match nft_ip_hdr_expr_close_scope_ip_constant_expr_int_hex_8b '\v(0x([A-Fa-f0-9]{1,2}))|(25[0-5])|(2[0-4][0-9])|(1[0-9][0-9])|([0-9]{1,2})\ze[ \t\n;]' skipwhite contained
\ nextgroup=
\    @nft_c_primary_stmt_expr
...
\ '\v(0x[0-9a-fA-F]{1,8})|(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])(\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])){3}'
\ skipwhite contained
\ nextgroup=
\    @nft_c_primary_stmt_expr,
\    @nft_c_stmt
...
\ '\v(0x[0-9a-fA-F]{1,8})|(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9][0-9]|[0-9])(\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9][0-9]|[0-9])){3}(\/(3[0-2]|[12][0-9]|[0-9]))'
\ skipwhite contained
\ nextgroup=
\    @nft_c_primary_stmt_expr,
\    @nft_c_stmt
...
hi link   nft_ip_hdr_expr_close_scope_ip_hdrlength_set_ref_expr_set_ref_symbol_expr_range_stmt_expr_symbol_dash nftHL_elements
...
hi link   nft_ip_hdr_expr_close_scope_ip_hdrlength_range_stmt_expr_keyword_dash nftHL_elements
...
hi link   nft_ip_hdr_expr_close_scope_ip_checksum_set_ref_expr_set_ref_symbol_expr_range_stmt_expr_symbol_dash nftHL_elements
...
hi link   nft_ip_hdr_expr_close_scope_ip_checksum_range_stmt_expr_keyword_dash nftHL_elements
...
hi link   nft_ip_hdr_expr_close_scope_ip_frag_off_set_expr_range_stmt_expr_symbol_dash nftHL_elements
...
hi link   nft_ip_hdr_expr_close_scope_ip_frag_off_range_stmt_expr_keyword_dash nftHL_elements
...
hi link   nft_ip_hdr_expr_close_scope_ip_protocol_set_ref_expr_set_ref_symbol_expr_range_stmt_expr_symbol_dash nftHL_elements
...
hi link   nft_ip_hdr_expr_close_scope_ip_protocol_range_stmt_expr_keyword_dash nftHL_elements
...
hi link   nft_ip_hdr_expr_close_scope_ip_hdrversion_set_ref_expr_set_ref_symbol_expr_range_stmt_expr_symbol_dash nftHL_elements
...
hi link   nft_ip_hdr_expr_hdrversion_set_expr_keyword_in nftHL_Operator
syn match nft_ip_hdr_expr_hdrversion_set_expr_keyword_in 'in' skipwhite contained
\ nextgroup=
...
hi link   nft_ip_hdr_expr_close_scope_ip_hdrversion_range_stmt_expr_keyword_dash nftHL_elements
...
syn match nft_ip_hdr_expr_close_scope_ip_hdrversion_relational_expr_relational_op_symbol_exclamation '\v\!|not\ze[ \t]' skipwhite contained
\ nextgroup=
\    nft_ip_hdr_expr_hdrversion_set_expr_keyword_in,
...
\    nft_map_expr_keyword_map,
\    nft_ip_hdr_expr_hdrversion_set_expr_keyword_in,
\    nft_ip_hdr_expr_close_scope_ip_hdrversion_relational_expr_relational_op_symbol_exclamation,
...
hi link   nft_ip_hdr_expr_close_scope_ip_length_set_ref_expr_set_ref_symbol_expr_range_stmt_expr_symbol_dash nftHL_elements
...
hi link   nft_ip_hdr_expr_close_scope_ip_length_range_stmt_expr_keyword_dash nftHL_elements
...
" *************** BEGIN 'ip option lsrr length' **********************
" Valid range 4-40 or 0x04-0x28
hi link   nft_ip_hdr_expr_close_scope_ip_constant_expr_int_hex_4b_field_length nftHL_Integer
syn match nft_ip_hdr_expr_close_scope_ip_constant_expr_int_hex_4b_field_length  '\v(0x2[0-8])|0x1[0-9a-fA-F]|0x[4-9a-fA-F]|40|[1-3][0-9]|[4-9]\ze[ \t\n;]' skipwhite contained
...
" BEGIN Operators - Set membership
hi link   nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_set_ref_symbol_expr_at_setname nftHL_Variable
syn match nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_set_ref_symbol_expr_at_setname '\v\@[a-zA-Z][a-zA-Z0-9\-_]{0,63}\ze[ \t]' skipwhite contained
\ nextgroup=
\    @nft_c_stmt

hi link   nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_string_expr_string_ip4_cidr_prefix nftHL_Integer
syn match nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_string_expr_string_ip4_cidr_prefix '\v(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])(/(3[0-2]|[12][0-9]|[0-9])){0,1}\ze[ \t\n;]' skipwhite contained

hi link   nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_payload_expr_string_ip4 nftHL_Integer
syn match nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_payload_expr_string_ip4 '\v(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\ze[ \t\n;]' skipwhite contained

hi link   nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_range_stmt_expr_symbol_dash nftHL_elements
syn match nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_range_stmt_expr_symbol_dash '\-' contained
\ nextgroup=
\    nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_payload_expr_string_ip4,
\    nft_Error

hi link   nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_payload_expr_string_ip4_range nftHL_Integer
syn match nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_payload_expr_string_ip4_range '\v(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\ze\-' contained
\ nextgroup=
\    nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_range_stmt_expr_symbol_dash,
\    nft_Error


hi link   nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_set_ref_symbol_expr_integer_expr_num_uint32_hex nftHL_Integer
syn match nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_set_ref_symbol_expr_integer_expr_num_uint32_hex '\v(0x[fF]|0x[0-9a-eA-E]|[1][0-5]|[0-9])\ze[ \t\n,]' skipwhite contained

hi link   nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_set_ref_symbol_expr_range_stmt_expr_symbol_dash nftHL_elements
syn match nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_set_ref_symbol_expr_range_stmt_expr_symbol_dash '\v\-' contained
\ nextgroup=
\    nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_set_ref_symbol_expr_integer_expr_num_uint32_hex

hi link   nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_set_ref_symbol_expr_integer_expr_num_uint32_hex_range nftHL_Integer
syn match nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_set_ref_symbol_expr_integer_expr_num_uint32_hex_range '\v(0x[fF]|0x[0-9a-eA-E]|[1][0-5]|[0-9])\ze\-' contained
\ nextgroup=
...
syn match nft_ip_hdr_expr_close_scope_ip_addr_payload_expr_string_ip4 '\v(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9]{1,2})(\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9]{1,2})){3}\ze[ \t\n\;]' skipwhite contained
\ nextgroup=
\    @nft_c_primary_stmt_expr,
\    @nft_c_stmt

hi link   nft_ip_hdr_expr_close_scope_ip_addr_range_stmt_expr_symbol_dash nftHL_Expression
...
syn match nft_ip_hdr_expr_close_scope_ip_addr_string_expr_string_ip4_cidr '\v((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])(\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9][0-9]|[0-9])){3})/(3[0-2]|[12][0-9]|[0-9])' skipwhite contained
\ nextgroup=
\    @nft_c_primary_stmt_expr,
\    @nft_c_stmt

hi link   nft_ip_hdr_expr_close_scope_ip_addr_payload_expr_string_ip4_range nftHL_Integer
syn match nft_ip_hdr_expr_close_scope_ip_addr_payload_expr_string_ip4_range '\v((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9]{1,2})(\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9]{1,2})){3})\ze\-' skipwhite contained
\ nextgroup=
...
hi link   nft_ip_hdr_expr_close_scope_ip_addr_hex_range_stmt_expr_symbol_dash nftHL_elements
...
syn match nft_ip_hdr_expr_close_scope_ip_saddr_integer_expr_num_uint32_hex_range
\ '\v((0x[0-9a-fA-F]{1,8})|429496729[0-5]|42949672[0-8][0-9]|4294967[01][0-9]{2}|429496[0-6][0-9]{3}|42949[0-5][0-9]{4}|4294[0-8][0-9]{5}|429[0-3][0-9]{6}|42[0-8][0-9]{7}|4[01][0-9]{8}|[1-3][0-9]{9}|[0-9]{1,8})\ze\-' contained
\ nextgroup=
...
\ nextgroup=
\    nft_ip_hdr_expr_close_scope_ip_addr_set_ref_expr_set_ref_symbol_expr_at_setname,
...
syn match nft_ip_hdr_expr_close_scope_ip_saddr_relational_expr_relational_op_keyword_not '\v\!\=\ze[ \t]' skipwhite contained
\ nextgroup=
\    nft_ip_hdr_expr_close_scope_ip_addr_string_expr_string_ip4_cidr,
\    nft_ip_hdr_expr_close_scope_ip_saddr_symbol_expr_variable_expr,
\    nft_ip_hdr_expr_close_scope_ip_addr_payload_expr_string_ip4_range,
...
hi link   nft_ip_hdr_expr_close_scope_ip_dscp_set_expr_range_stmt_expr_symbol_dash nftHL_elements
...
hi link   nft_ip_hdr_expr_close_scope_ip_dscp_range_stmt_expr_symbol_dash nftHL_elements
...
hi link   nft_ip_hdr_expr_close_scope_ip_ecn_range_stmt_expr_keyword_dash nftHL_elements
...
hi link   nft_ip_hdr_expr_close_scope_ip_ttl_set_ref_expr_set_ref_symbol_expr_range_stmt_expr_symbol_dash nftHL_elements
...
hi link   nft_ip_hdr_expr_close_scope_ip_ttl_range_stmt_expr_keyword_dash nftHL_elements
...
hi link   nft_ip_hdr_expr_close_scope_ip_id_range_stmt_expr_keyword_dash nftHL_elements
