...
hi link   nft_line_separator nftHL_Separator
...
syn region nft_comment_spec_string_quoted_double start='\"' end='\"' skip="\\\"" skipwhite contained
\ contains=
...
syn match nft_add_cmd_flowtable_block_hook_keyword_priority_extended_var "\v\$[a-zA-Z][a-zA-Z0-9\\\/_\.\-]{0,63}" skipwhite contained
...
syn match nft_add_cmd_flowtable_block_hook_keyword_priority_extended_name "\v[a-zA-Z][a-zA-Z]{1,16}" skipwhite contained
\ nextgroup=
...
syn region nft_add_cmd_flowtable_block_hook_identifier_quoted_single start="'" end="'" skip="\\\'" skipwhite skipnl skipempty contained
\ nextgroup=
\    nft_add_cmd_flowtable_block_hook_keyword_priority,
\    nft_Error
...
syn match nft_delete_cmd_keyword_limit_obj_or_id_spec_obj_spec_identifier_limit '\v[a-zA-Z][a-zA-Z0-9\\\/_\.\-]{0,63}' skipwhite contained
\ nextgroup=
\    nft_line_separator,
\    nft_EOS,
\    nft_Error
...
syn match nft_delete_cmd_keyword_limit_obj_or_id_spec_table_spec_identifier_table '\v[a-zA-Z][a-zA-Z0-9\\\/_\.\-]{0,63}' skipwhite contained
\ nextgroup=
\    nft_delete_cmd_keyword_limit_obj_or_id_spec_objid_spec_keyword_handle,
...
syn match nft_add_cmd_keyword_element_set_spec_table_spec_identifier_string_table "\v[a-zA-Z][a-zA-Z0-9\\\/_\.\-]{0,63}\ze[ \t]" skipwhite contained
\ nextgroup=
...
syn match nft_add_cmd_keyword_element_set_spec_table_spec_family_spec "\v(ip6?|inet|netdev|bridge|arp)\ze[ \t]" skipwhite contained
\ nextgroup=
...
syn match nft_add_cmd_rule_rule_alloc_stmt_meter_stmt_meter_stmt_alloc_identifier '\v[a-zA-Z0-9\\\/_\.\-]{1,64}\ze[ \t\n]' skipwhite contained
\ nextgroup=
...
hi link   nft_add_cmd_rule_rule_alloc_stmt_meta_stmt_meta_key_unqualified_keyword_rtclassid nftHL_Action
...
hi link   nft_add_cmd_rule_rule_alloc_stmt_meta_stmt_meta_key_unqualified_keyword_ibriport nftHL_Action
...
hi link   nft_add_cmd_rule_rule_alloc_stmt_meta_stmt_meta_key_qualified_keyword_priority nftHL_Action
...
hi link   nft_add_cmd_rule_rule_alloc_stmt_meta_stmt_meta_key_qualified_keyword_protocol nftHL_Action
...
hi link   nft_add_cmd_rule_rule_alloc_stmt_meta_stmt_meta_key_unqualified_keyword_ibrname nftHL_Action
...
hi link   nft_add_cmd_rule_rule_alloc_stmt_meta_stmt_meta_key_unqualified_keyword_iifname nftHL_Action
...
hi link   nft_add_cmd_rule_rule_alloc_stmt_meta_stmt_meta_key_unqualified_keyword_iiftype nftHL_Action
...
hi link   nft_add_cmd_rule_rule_alloc_stmt_meta_stmt_meta_key_unqualified_keyword_nftrace nftHL_Action
...
hi link   nft_add_cmd_rule_rule_alloc_stmt_meta_stmt_meta_key_unqualified_keyword_obrname nftHL_Action
...
hi link   nft_add_cmd_rule_rule_alloc_stmt_meta_stmt_meta_key_unqualified_keyword_oifname nftHL_Action
...
hi link   nft_add_cmd_rule_rule_alloc_stmt_meta_stmt_meta_key_unqualified_keyword_oiftype nftHL_Action
...
hi link   nft_add_cmd_rule_rule_alloc_stmt_meta_stmt_meta_key_unqualified_keyword_pkttype nftHL_Action
...
hi link   nft_add_cmd_rule_rule_alloc_stmt_meta_stmt_meta_key_unqualified_keyword_ipsec nftHL_Action
...
hi link   nft_add_cmd_rule_rule_alloc_stmt_meta_stmt_keyword_meta nftHL_Action
...
" THE vector point to over 73 lexical tokens/keywords, this nft_base_cmd_add_cmd_rule_position_chain_spec_table_spec_identifier
...
syn match nft_add_cmd_table_block_keyword_limit_obj_spec_identifier "\v[A-Za-z][A-Za-z0-9\\\/_\.\-]{0,63}" skipwhite contained
\ nextgroup=
...
syn match nft_add_cmd_set_block_typeof_key_expr_type_data_type_expr "\v[a-zA-Z][a-zA-Z0-9\\\/_\.\-]{0,63}" skipwhite contained
\ nextgroup=
...
syn match nft_add_cmd_set_block_time_spec "\v[a-zA-Z0-9\\\/_\.\:]{1,31}" skipwhite contained
\ nextgroup=
...
syn match nft_add_cmd_set_block_expr_variable_expr "\v\$[a-zA-Z][a-zA-Z0-9\\\/_\.\-]{0,31}" contained
\ nextgroup=
\    nft_Semicolon,
\    nft_UnexpectedEOS,
\    nft_Error
...
syn region nft_add_cmd_keyword_table_table_block_chain_chain_block_delimiters start="{" end="}" skipwhite contained
\ nextgroup=
...
syn match nft_add_cmd_table_block_set_block_keyword_elements_set_block_expr_equal /=/ skipwhite contained
\ nextgroup=
...
syn match nft_table_block_ct_expect_block_ct_expect_config_protocol_tcp_expression_equal /=/ skipnl skipwhite contained
\ nextgroup=
...
syn match nft_table_block_ct_expect_block_ct_expect_config_protocol_udp_expression_equal /=/ skipnl skipwhite contained
\ nextgroup=
...
syn match nft_table_block_ct_timeout_block_ct_timeout_config_protocol_tcp_expression_equal /=/ skipnl skipwhite contained
\ nextgroup=
...
syn match nft_table_block_ct_timeout_block_ct_timeout_config_protocol_udp_expression_equal /=/ skipnl skipwhite contained
\ nextgroup=
...
syn region nft_add_cmd_keyword_table_table_block_delimiters start="{" end="}" skipempty skipwhite contained
\ nextgroup=
\    nft_EOS,
\    nft_line_separator
\ contains=
...
syn match nft_common_block_define_redefine_equal '\v\=' skipwhite contained
\ nextgroup=
...
syn match nft_common_block_define_redefine_keywords_identifier '\v[a-zA-Z][a-zA-Z0-9_\-]{0,63}' skipwhite contained
\ nextgroup=
...
syn match nft_common_block_undefine_identifier_keyword_last '\vlast' contained
\ nextgroup=
\    nft_common_block_stmt_separator,
\    nft_UnexpectedCurlyBrace,
\    nft_EOS,
...
syn match nft_common_block_keyword_undefine "\vundefine\ze[ \t]" skipnl skipwhite contained
\ nextgroup=
