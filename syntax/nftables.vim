...
syn match nft_line_comment_line "\v#.{0,79}$" skipwhite contained
...
hi link   nft_line_tmp_keyword_error nftHL_Command
syn match nft_line_tmp_keyword_error "\<error\>" skipwhite contained
\ nextgroup=
